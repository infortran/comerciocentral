<!--==========================================
        CONFIG GENERAL (Panel principal)
=============================================-->
                        ...
                        <div class="accordion" id="accordionExample">
                            ...
                            <div class="card">
                                ...
                                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                                    <div class="card-body">
                                        <!------------------------------>
                                        <form class="container" action="" method="POST" enctype="multipart/form-data"><!--.container-->
                                            @method('PATCH')
                                            @csrf
                                            @if ($errors->any())
                            ...
                            <div class="card">
                                <div class="card-header" id="headingThree">
                                    <div class="row">
                                        ...
                                        <div class="col-2"  style="display:flex;align-items: center">
                                            <span style="font-size: 14px" class="badge badge-pill badge-primary float-right">{{$tienda->slides->count()}}</span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="container">
                                            <div class="row flex-row flex-nowrap" style="overflow-x: scroll;">
                                                ...
                                                @foreach($tienda->slides as $slide)
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item">
                                                <table class="table table-striped">
                                                    ...
                                                    <tbody>
                                                    @foreach($tienda->envios as $envio)
                                                        <tr>
